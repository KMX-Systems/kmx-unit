...
namespace kmx::unit::data_rate
{
    ...
    TEST_CASE("Data Rate Unit Tests", "[data_rate]")
    {
        ...
        {
            auto rate1 = _Mb(100.0) / _s(1.0); // 100 Mbps
        ...
        SECTION("Arithmetic")
        {
            ...
            auto fileSize = _GiB(1.0);
            auto netSpeed = _Mbps(100.0);
            ...
            auto timeInSeconds = fileSize.as_si() / netSpeed.as_si();
    ...
    TEST_CASE("Large Data Rate Tests (Giga)", "[data_rate][large]")
    {
        SECTION("Derived Rate Creation")
        {
            auto rate1 = _Gb(10.0) / _s(1.0); // 10 Gbps
        ...
        SECTION("Arithmetic")
        {
            ...
            auto data_store_size = _TiB(50.0);
            auto network_speed = _Gbps(10.0);

            auto time_in_seconds = data_store_size.as_si() / network_speed.as_si();
            auto time_in_days = convert<day<>>(second<>(time_in_seconds));
