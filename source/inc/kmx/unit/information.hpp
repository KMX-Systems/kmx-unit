...
namespace kmx::unit
{
    KMX_UNIT_FACTORY_FUNCTIONS(_b, information::bit)
    KMX_UNIT_FACTORY_FUNCTIONS(_B, information::byte)
    KMX_UNIT_FACTORY_FUNCTIONS(_kb, information::kilobit)
    KMX_UNIT_FACTORY_FUNCTIONS(_kB, information::kilobyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Mb, information::megabit)
    KMX_UNIT_FACTORY_FUNCTIONS(_MB, information::megabyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Gb, information::gigabit)
    KMX_UNIT_FACTORY_FUNCTIONS(_GB, information::gigabyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Tb, information::terabit)
    KMX_UNIT_FACTORY_FUNCTIONS(_TB, information::terabyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Pb, information::petabit)
    KMX_UNIT_FACTORY_FUNCTIONS(_PB, information::petabyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Kib, information::kibibit)
    KMX_UNIT_FACTORY_FUNCTIONS(_KiB, information::kibibyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Mib, information::mebibit)
    KMX_UNIT_FACTORY_FUNCTIONS(_MiB, information::mebibyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Gib, information::gibibit)
    KMX_UNIT_FACTORY_FUNCTIONS(_GiB, information::gibibyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Tib, information::tebibit)
    KMX_UNIT_FACTORY_FUNCTIONS(_TiB, information::tebibyte)
    KMX_UNIT_FACTORY_FUNCTIONS(_Pib, information::pebibit)
    KMX_UNIT_FACTORY_FUNCTIONS(_PiB, information::pebibyte)
}
